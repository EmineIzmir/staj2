...
public class ProcessesForParsing {
	...
	/**
	 * This method calls methods and all processes are executed.
	 * 
	 * @param complaintList
	 * @throws Exception
	 */
	...
	/**
	 * This method takes addresses of complaints from document.
	 * 
	 * @param htmlCode
	 * @throws IOException
	 */
	...
	/**
	 * Takes informations of baslik, sikayet, firma, sikayetDurumu and kullanici
	 * from document and returns this informations as a complaint object
	 * 
	 * @param htmlCode
	 * @return
	 * @throws Exception
	...
	/**
	 * writes complaint object to .json file
	 * @param compObj
	 * @param fileName
	 * @throws IOException
	 */
...
/**
 * sends post request for changeing page.
